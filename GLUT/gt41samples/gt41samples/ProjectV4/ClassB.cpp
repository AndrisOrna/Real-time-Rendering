...
string ClassB::readFile(string fileName)
{
...
void ClassB::addShader(GLuint shaderProgram, const char* pShaderText, GLenum shaderType)
{
...
void ClassB::buildShader(string vertexShaderPath, string fragmentShaderPath)
{
