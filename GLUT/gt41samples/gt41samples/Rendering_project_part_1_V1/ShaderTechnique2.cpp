...
ShaderTechnique2::ShaderTechnique2()
{

}

string ShaderTechnique2::readFile(string fileName)
{
...
void ShaderTechnique2::addShader(GLuint shaderProgram, const char* pShaderText, GLenum shaderType)
{
...
void ShaderTechnique2::buildShader(string vertexShaderPath, string fragmentShaderPath)
{
